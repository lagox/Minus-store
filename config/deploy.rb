# lagox - Поменять на ваш логин в панели управления
# theminus - Поменять на имя вашего проекта
# lithium - Поменять на имя вашего сервера (Указано на вкладке "FTP и SSH" вашей панели управления)
